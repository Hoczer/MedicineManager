...
namespace MedicineManagerAPI.Migrations
{
    ...
    [Migration("20230225195745_update2")]
            ...
            modelBuilder.Entity("MedicineManagerAPI.Entities.Diet", b =>
                {
                    ...
                    b.Property<DateTime>("WhenToEat")
                        ...
                        .HasDefaultValue(new DateTime(2023, 2, 25, 20, 57, 45, 104, DateTimeKind.Local).AddTicks(1280));
            ...
            modelBuilder.Entity("MedicineManagerAPI.Entities.MedicineCabinet", b =>
                {
                    ...
                    b.Property<DateTime>("MedExpirationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 27, 20, 57, 45, 106, DateTimeKind.Local).AddTicks(8127));
            ...
            modelBuilder.Entity("MedicineManagerAPI.Entities.Treatment", b =>
                {
                    ...
                    b.Property<DateTime>("MedWhenToTake")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 25, 20, 57, 45, 106, DateTimeKind.Local).AddTicks(7195));
